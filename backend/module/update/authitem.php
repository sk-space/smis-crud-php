<?php
    ...
    if(isset($_POST['update'])){
      ...
      // echo '<br><br>This is me new one '.$new_id.' and '.$new_title.' and '.$detail.' and '.$status.' and '.$postby_id.' and '.$verifiedby_id;
      // die();

      $query0 = $user->updateAuthitem($id, $title, $new_id, $new_title, $detail, $postby_id, $verifiedby_id, $status);
        ...
        <div class="center">
            <ol class="breadcrumb">
                <li>
                    ...
                    <i class="glyphicon glyphicon-leaf"></i> <a href="../authitem.php">Authitem</a>
                </li>
                <li class="active">
            ...
            <?php 
              if($query0 == 1){?>
                  <div class="alert alert-warning fade in" style="width: 100%; margin: -20px 0px 20px;">
                    ...
                    <strong>Authitem Title And ID Already Exists !</strong> Choose Another Title and ID.
                  </div><?php 
              }
              if($query0 == 2){?>
                  <div class="alert alert-warning fade in" style="width: 100%; margin: -20px 0px 20px;">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>Authitem ID Already Exists !</strong> Choose Another ID.
                  </div><?php                 
              }
              if($query0 == 3){?>
                  <div class="alert alert-warning fade in" style="width: 100%; margin: -20px 0px 20px;">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>Authitem Title Already Exists !</strong> Choose Another Title.
                  </div><?php                 
              }
            ?>
            <section>
              <form class="form-horizontal" action="" method="post" >
                <div class="row">
                    ...
                    <div class="col-sm-6 left">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName2"  class="control-label">Authitem Title</label>
                        <div class="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="">
                          <textarea rows="4" cols="46" name='detail' placeholder="Small Description About The Authitem..."><?php echo $result['details']?></textarea>
                          ...
                          <div class="">
                              <?php
                                  ...
                                  while($result1 = mysqli_fetch_assoc($query1)){
                                    if($result1['fullname'] != $result['fullname'])
