                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="glyphicon glyphicon-list"></i> ItemGroup
                                </li>
                            </ol>
                        </div>
                        <div class="col-md-2">
                            <ol style="list-style: none; ">
                                <li><i class="glyphicon glyphicon-list"></i>&nbsp;&nbsp;<a href="list/itemgroup.php">List</a></li>
                                <!-- <li><i class="glyphicon glyphicon-pencil" style="font-size:12px; border: solid 1px #F5F5F5;"></i>&nbsp;&nbsp;<a href="create/itemgroup.php">Create</a></li> -->
                                <?php
                                    if(/*($aiid[0] == 1 && $access[0] == 'YES') || */($ugid == 1 || 2)){
                                        echo '<li><i class="glyphicon glyphicon-pencil" style="font-size:12px; border: solid 1px #F5F5F5;"></i>&nbsp;&nbsp;<a href="create/itemgroup.php">Create</a></li>';
                                    }
                                    else{
                                        echo '<li><i class="glyphicon glyphicon-pencil" style="font-size:12px; border: solid 1px #F5F5F5;"></i>&nbsp;&nbsp;<a href="create/itemgroups.php"> X </a></li>';
                                    }
                                ?>
                            </ol>
                        </div>
                    ...
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                            <li role="presentation" class="active">
                              <a href="#on" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
                                <span class="text">ItemGroup <small><i>Status ON</i></small></span>
                              </a>
                            </li>
                            <li role="presentation" class="next">
                              <a href="#off" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">
                                <span class="text">ItemGroup <small><i>Status OFF</i></small></span>
                              </a>
                            </li>
                        </ul><hr>
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="on" aria-labelledby="home-tab">
                                ...
                                <div class="panel panel-primary filterable">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"> ItemGroup <small style="text-transform: capitalize;"><i>Status ON</i></small></h3>
                                    </div>
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                          ...
                                          $page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
                                            ...
                                            $statement = "`itemgroup` WHERE `status` = 'ON' order by `id` ASC"; //you have to pass your query over here
                                          $query = mysqli_query($connection, "select * from {$statement} LIMIT {$startpoint} , {$limit}");
                                        // $query = $user->onItemgroup();
                            ...
                            <div role="tabpanel" class="tab-pane  fade" id="off" aria-labelledby="profile-tab">
                                ...
                                <div class="panel panel-primary filterable">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"> ItemGroup <small style="text-transform: capitalize;"><i>Status OFF</i></small></h3>
                                    </div>
                                    <table class="table table-hover">
                                        <thead class="info">
                                            <tr class="filters">
