<?php
  ...
  if(isset($_POST['create'])){ 
    ...
    // echo '<br><br> Print: '.$title.' and '.$detail.' and '.$status.' and ID: '.$id;
    // die();

    $result = $user->createAuthitem($title, $detail, $status, $id);
    if($result == 1){
            ...
            <ol class="breadcrumb">
                ...
                if($result == 2){?>
                  <div class="alert alert-warning fade in" style="width: 100%; margin: -20px 0px 20px;">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>Authitem Already Exists !</strong> Choose Another Title.
                  </div><?php          
                }?>
            <section>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 left">
                    ...
                    <div class="form-group">
                      ...
                      <div class=""><i>
                        <textarea rows="4" cols="46" name='detail' placeholder=" About The Authitem..."></textarea></i>
                      </div>
                    </div>
                  </div>
